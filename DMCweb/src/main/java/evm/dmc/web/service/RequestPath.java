...
//	@Getter public static final String assignAlgorithm = algorithm + assign;
//	@Getter public static final String projAssignAlgorithm = project + assignAlgorithm;

    @Getter
    public static final String setSource = "/setsrc";
    @Getter
    public static final String getSource = "/getsrc";
    @Getter
    public static final String setSourceAttributes = "/setsrcattr";

    @Getter
    public static final String algorithmWozard = "/project/algorithm/wizard";


    @Getter
    public static final String erAccDenied = "/errors/accessDenied";
    @Getter
    public static final String erNotFound = "/errors/notFound";
