...
public interface MetaDataService extends EnityGetterService<MetaData>, EntityModifierService<MetaData>{
	...
	List<MetaData> getProjectDatasetsAsList(Long projectId);
